...
class ClientMetricsLogger:
        ...
        if not self.csv_path.exists():
            if self.extended:
                headers = [
                    ...
                    "dp_enabled",
                    "attack_mode",
                    "macro_f1_global_holdout",
                    "micro_f1_global_holdout",
                    "f1_per_class_holdout",
                    "confusion_matrix_counts_holdout",
                    "confusion_matrix_normalized_holdout",
                    "confusion_matrix_class_names_holdout",
                    "secure_aggregation",
    ...
    def log_round_metrics(
        ...
        macro_f1_global_holdout: Optional[float] = None,
        micro_f1_global_holdout: Optional[float] = None,
        f1_per_class_holdout_json: Optional[str] = None,
        confusion_matrix_counts_holdout_json: Optional[str] = None,
        confusion_matrix_normalized_holdout_json: Optional[str] = None,
        confusion_matrix_class_names_holdout_json: Optional[str] = None,
        ...
        if self.extended:
            row = [
                ...
                attack_mode or "",
                str(macro_f1_global_holdout) if macro_f1_global_holdout is not None else "",
                str(micro_f1_global_holdout) if micro_f1_global_holdout is not None else "",
                f1_per_class_holdout_json or "",
                confusion_matrix_counts_holdout_json or "",
                confusion_matrix_normalized_holdout_json or "",
                confusion_matrix_class_names_holdout_json or "",
