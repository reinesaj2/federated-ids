...
**Implication:**
*   How does introducing 10% malicious actors *improve* the model to perfection?
...
*   The "Personalization" gains (~6% for CIC) are the only evidence that the task isn't *completely* solved by a global linear model.
...
1.  **Fix the Metric Aggregator:**
    ...
    *   *Priority: Critical.* We cannot put "F1 = 2.65" in a thesis.
