        ...
        if self.aggregation == "bulyan":
            ...
            if self.n_clients < required:
                return (
                    False,
                    (
                        f"Bulyan requires n >= 4f+3; got n={self.n_clients}, "
                        f"f={f}, required={required}"
                    ),
                )
            ...
            if self.n_clients < required:
                return (
                    False,
                    (
                        f"Krum requires n >= 2f+3; got n={self.n_clients}, "
                        f"f={f}, required={required}"
                    ),
                )
            ...
            if self.n_clients < required:
                return (
                    False,
                    (
                        f"Median requires n >= 2f+1; got n={self.n_clients}, "
                        f"f={f}, required={required}"
                    ),
                )
        ...
        for agg in self.aggregations:
            for adv_frac in self.adversary_fractions:
                ...
                if is_valid:
                    ...
                    impossible.append(
                        f"SKIP (impossible): {config_name} - {reason}"
                    )
