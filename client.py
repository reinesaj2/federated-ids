...
def main() -> None:
    ...
    parser.add_argument(
        "--adversary_clip_factor",
        type=float,
        default=2.0,
        help="Gradient clipping factor for adversarial attacks (multiplier of 100x base norm)",
    )
    ...
    client = TorchClient(
        ...
        runtime_config={
            ...
            "adversary_clip_factor": float(os.environ.get("D2_ADVERSARY_CLIP_FACTOR", str(args.adversary_clip_factor))),
